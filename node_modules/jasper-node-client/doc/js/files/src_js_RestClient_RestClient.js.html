...
<head>
    <meta charset="utf-8">
    <title>src/js/RestClient/RestClient.js - jasper_report_node_client</title>
    ...
    <div id="bd" class="yui3-g">
        ...
        <div class="yui3-u-3-4">
            ...
            <div class="apidocs">
                <div id="docs-main">
                    <div class="content">
<h1 class="file-heading">File: src/js/RestClient/RestClient.js</h1>
 ...
 */
  get(path, endpoint, fileFormat, params, callback, errorHandler) {
	...
	var peticion = this.client.get(fullUrl, args, callback).on(&#x27;error&#x27;, errorHandler);
	}
}
